<template>
	<div class="item-wrap">
		<el-table :data="getSoItem.data" empty-text="No Data" border>
			...
			<el-table-column prop="INVOICE" label="Invoice" width="120">
			</el-table-column>
			...
			<el-table-column prop="DNQTY" label="ODM Invoice Status" width="120">
			</el-table-column>
			...
			<el-table-column prop="UPDATEDAY" label="ODM GR No." width="120">
			</el-table-column>
